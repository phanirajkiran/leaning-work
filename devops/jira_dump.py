...
class Jira(object):
    def runJqlQuery(self):
        ...
        url = "https://jira.wrs.com/rest/api/2/project/LTAF8-620/components"
        url = "https://jira.wrs.com/rest/api/2/project/SCP9-98/components"
        url = "https://jira.wrs.com/rest/api/2/issue/SCP9-98"
